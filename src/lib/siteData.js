...
export const projects = [
  {
    ...
    thumbnail: "/project-images/capstone_0.png",
    gallery: [
      "/project-images/capstone_0.png",
      "/project-images/capstone_1.png",
      "/project-images/capstone_2.png",
      "/project-images/capstone_3.png",
      "/project-images/capstone_4.png",
    ],
  ...
  },
  {
    ...
    icon: ShieldCheck,
    thumbnail: "/project-images/mptool_0.png",
    gallery: [
      "/project-images/mptool_0.png",
      "/project-images/mptool_1.png",
      "/project-images/mptool_2.png",
      "/project-images/mptool_3.png",
    ],
    github: "",
    live: "",
    isOpen: false,
  },
  {
    ...
    gallery: [
      "/project-images/inAppBi_Chart.png",
      "/project-images/inAppBi.png",
      "/project-images/inAppBi_Data.png",
    ],
    github: "",
    live: "https://www.inappbi.com/",
    isOpen: false,
  },
  {
    id: 9,
...

  {
    ...
    icon: Rocket,
    thumbnail: "/project-images/epp_0.png",
    gallery: [
      "/project-images/epp_0.png",
      "/project-images/epp_1.png",
      "/project-images/epp_2.png",
      "/project-images/epp_3.png",
    ],
    github: "",
    live: "https://play.google.com/store/apps/details?id=com.strllc.eppmobile&hl=en",
    isOpen: false,
  },
  {
    id: 8,
...

  {
    ...
    icon: GitBranch,
    thumbnail: "/project-images/nextup_1.png",
    gallery: [
      "/project-images/nextup_1.png",
      "/project-images/nextup_2.png",
      "/project-images/nextup_3.png",
    ],
    github: "",
    live: "https://play.google.com/store/apps/details?id=com.nextup.app&hl=en",
    isOpen: false,
  },
  {
    id: 7,
